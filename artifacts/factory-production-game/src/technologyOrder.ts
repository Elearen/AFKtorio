...
export const technologyOrder = [
  ...
  'artillery', 'atomic-bomb', 'braking-force-7', 'destroyer', 'inserter-capacity-bonus-7', 'laser-shooting-speed-6', 'laser-weapons-damage-6', 'personal-roboport-mk2-equipment', 'power-armor-mk2', 'refined-flammables-5', 'space-science-pack', 'ai-powered-infinite-research', 'spidertron', 'stronger-explosives-5', 'uranium-ammo', 'worker-robots-speed-3', 'worker-robots-storage-3',
